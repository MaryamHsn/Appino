...
//{
//    public class GenericRepository<TEntity> : IRepository<TEntity> where TEntity : TEntity // Entity, new()
//    {
...
//            var entity = _context.RequestTempTbl.Where(a => a.Id == id).FirstOrDefault();
